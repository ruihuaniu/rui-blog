---
id: 1
title: Two Sum with new solutions
...
:::tip
 ...
 - Check if the difference exists in the Object/Map
:::
...
#### 2. Option 2: Using one for loop with an extra Object
...
#### Option 3: Using one for loop with an extra Map
